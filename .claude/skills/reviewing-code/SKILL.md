...
1. **Nayru agent** -- correctness, architecture, test coverage, style
2. **Laverna agent** -- vulnerabilities, operational risks (timeouts, resource leaks, error handling at boundaries), secrets
